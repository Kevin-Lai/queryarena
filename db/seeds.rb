...
q58 = Question.create(user_id: creator.id, body: "What is the main gas that makes up the Earth’s atmosphere?")
...
q80 = Question.create(user_id: guest.id, body: "How many times does hummingbird beat its wings in a second?")
...
q95 = Question.create(user_id: u5.id, body: "If you could travel at light speed, what would you see?")
q96 = Question.create(user_id: creator.id, body: "What are some mind-blowing facts that sound unreal but are actually true?")
q97 = Question.create(user_id: u5.id, body: "Which planet in our solar system has 53 moons?")
...
Answer.create(user_id: creator.id, question_id: q30.id, body: "Chlorophyll")
Answer.create(user_id: u2.id, question_id: q31.id, body: "Color blindness occurs when you are unable to see colors in a normal way. It is also known as color deficiency. Color blindness often happens when someone cannot distinguish between certain colors. Color blindness can happen when one or more of the color cone cells are absent, not working, or detect a different color than normal.")
...
Answer.create(user_id: creator.id, question_id: q33.id, body: "Pitcher plants are several different carnivorous plants which have modified leaves known as pitfall traps that acts as a prey-trapping mechanism featuring a deep cavity filled with digestive liquid.")
...
Answer.create(user_id: guest.id, question_id: q57.id, body: "Diamonds!")
Answer.create(user_id: guest.id, question_id: q58.id, body: "Nitrogen")
Answer.create(user_id: u5.id, question_id: q59.id, body: "98.8 percent!")
Answer.create(user_id: u3.id, question_id: q60.id, body: "Nitrogen")
...
Answer.create(user_id: u10.id, question_id: q72.id, body: "Venus")
